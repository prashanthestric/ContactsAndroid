...
/**
 * Adapter for the phone number and email listView in ContactViewer activity.
 */
public class ContactViewerAdapter extends ArrayAdapter<String[]> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.fieldvalueView.setText(rowItem[1].length()<29?rowItem[1]:rowItem[1].substring(0, 28)+"..");
